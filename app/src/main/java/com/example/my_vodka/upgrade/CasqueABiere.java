...
public class CasqueABiere extends UpgradeAbstract{
    public CasqueABiere(String informations, String alcoolName, double alcoolPrice, double alcoolMultiply, float activeBonus, float passiveBonus, String speciality) {
